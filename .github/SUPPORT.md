# Getting help with sessiondiverge

Thanks for using sessiondiverge. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/sessiondiverge/issues) to make sure the 
